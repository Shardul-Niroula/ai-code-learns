...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-secondary overflow-hidden">
      ...
      {/* Navigation Tabs */}
      <div className="bg-primary border-b border-color px-4 md:px-6 pt-1 md:pt-2 flex items-center shrink-0">
      ...
      {/* Footer Info */}
      <footer className="h-6 md:h-8 bg-primary border-t border-color flex items-center justify-between px-4 md:px-6 shrink-0 text-[8px] md:text-[10px] text-secondary uppercase tracking-widest font-bold">
